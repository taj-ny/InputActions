...
NODEPARSER_BASE(int16_t, "a 16-bit signed integer");
NODEPARSER_BASE(int32_t, "a 32-bit signed integer");
NODEPARSER_BASE(int64_t, "a 64-bit signed integer");
NODEPARSER_BASE(uint8_t, "an 8-bit unsigned integer");
NODEPARSER_BASE(uint16_t, "a 16-bit unsigned integer");
